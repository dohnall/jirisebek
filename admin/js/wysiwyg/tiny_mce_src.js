	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, settings) {
			...
			self.settings = settings = extend({
				...
				delta_height : 0,
				popup_css : '',
				plugins : 'safari,pagebreak,table,advhr,advimage,advlink,inlinepopups,contextmenu,paste,noneditable,visualchars,nonbreaking,xhtmlxtras,imagemanager,filemanager',
