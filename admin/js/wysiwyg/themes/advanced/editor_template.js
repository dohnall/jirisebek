		...
		init : function(ed, url) {
			...
			if (!s.theme_advanced_buttons1) {
				s = extend({
		    		...
		    		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,bullist,numlist,|,blockquote,|,undo,redo,|,link,unlink,anchor,image,insertimage,insertfile,cleanup,code",
		    		theme_advanced_buttons3 : "tablecontrols,|,hr,|,sub,sup,|,charmap,iespell,media,cite,abbr,acronym,attribs,|,visualchars,nonbreaking,pagebreak",
				}, s);
			}
