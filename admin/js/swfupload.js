...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("upload_url", AJAX + "upload.php");
	...
	this.ensureDefault("file_size_limit", "100 MB");	// Default zero means "unlimited"
	this.ensureDefault("file_upload_limit", 0);
	this.ensureDefault("file_queue_limit", 0);

	// Flash Settings
	this.ensureDefault("flash_url", JS + "swfupload.swf");
	this.ensureDefault("prevent_swf_caching", true);
	
	// Button Settings
	this.ensureDefault("button_image_url", DESIGN + "xpbutton.png");
	this.ensureDefault("button_width", 61);
	...
	this.ensureDefault("button_placeholder_id", "upload");
